from Python_autotests.pages.alerts_frame_windows_page import BrowserWindowsPage, AlertsPage, FramesPage, \
...
class TestAlertsFrameWindow:
    ...
    class TestNestedFramesPage:
        ...
        def test_nested_frames(self, driver):
            ...
            assert child_text == 'Child frame', "Nested frame does not exist"
    ...
    class TestModalDialogsPage:
        ...
        def test_modal_dialogs(self, driver):
            ...
            small, large = modal_dialogs_page.check_modal_button()
            print(small)
            print(large)
            assert small[1] < large[1], "Text from the large dialog is less than from the small dialog"
