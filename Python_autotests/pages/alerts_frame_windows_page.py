...
from Python_autotests.locators.alerts_frame_windows_page_locators import BrowserWindowsPageLocators, AlertsPageLocators, \
...
class ModalDialogsPage(BasePage):
    ...
    def check_modal_button(self):
        self.element_is_visible(self.locators.SMALL_MODAL_BUTTON).click()
        title_small = self.element_is_present(self.locators.SMALL_MODAL_TITLE).text
        body_small_text = self.element_is_present(self.locators.SMALL_MODAL_BODY).text
        self.element_is_visible(self.locators.CLOSE_SMALL_MODAL_BUTTON).click()
        self.element_is_visible(self.locators.LARGE_MODAL_BUTTON).click()
        title_large = self.element_is_present(self.locators.LARGE_MODAL_TITLE).text
        body_large_text = self.element_is_present(self.locators.LARGE_MODAL_BODY).text
