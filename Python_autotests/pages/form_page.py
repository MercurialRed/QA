...
from Python_autotests.locators.form_page_locators import FormPageLocators
...
class FormPage(BasePage):
    ...
    def fill_form_fields(self):
        ...
        #self.click_by_script(self.element_is_present(self.locators.SELECT_STATE))
        ...
        #self.click_by_script(self.element_is_present(self.locators.SELECT_CITY))
